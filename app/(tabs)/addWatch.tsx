  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      {/* <View className="flex-row items-center px-4 py-3 bg-white border-b border-gray-100">
        ...
        <View>
          <Text className="text-lg font-semibold text-gray-900">Add Watch</Text>
          <Text className="text-sm text-gray-600">Enter watch details</Text>
        </View>
      </View> */}
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="p-6">
          ...
          {/* Action Buttons */}
          <View className="flex-row space-x-3 mt-8 mb-6">
            <TouchableOpacity
              onPress={() => router.back()}
