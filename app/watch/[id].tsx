...
export default function WatchDetailPage() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Hero Section — Image background — intentionally always dark */}
        <View className="relative h-96 bg-gray-500 overflow-hidden">
          {/* Back Button */}
          <TouchableOpacity
          ...
          {/* Watch Info Overlay — white text on top of the image */}
          {/* <View className="absolute bottom-0 p-6 rounded-tr-2xl"> */}
        ...
        <View className="mx-4 mt-8 ">
          ...
          <Text className="text-gray-900 dark:text-gray-400 text-center text-xl font-bold mb-2">
            {watch.line}
          </Text>
        </View>
